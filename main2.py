...
def main():
    # User inputs
    mode = input("Choose mode (1 for multiple SKUs, 2 for single SKU batch): ")
    ...
    barcode_width, barcode_height = (
        int(2.42 * 300),
        300,
    )  # 2.42 inches x 1 inch at 300 DPI
    ...
    if mode == "1":
        ...
        single_sku = input("Enter the SKU to generate: ")
        num_copies = int(input("Enter the number of copies for this SKU: "))
        skus = [single_sku for _ in range(num_copies)]
    else:
